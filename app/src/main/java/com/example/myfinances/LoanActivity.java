...
public class LoanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.loan_activity), (v, insets) -> {
    ...
    private void initSaveButton() {
        Button saveButton = findViewById(R.id.buttonSaveLoan);
        ...
        if (saveButton != null) {
            saveButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    FinanceDataSource ds = new FinanceDataSource(LoanActivity.this);
                    ...
                    try {
                        ...
                        account.setPaymentAmount(Double.parseDouble(((EditText) findViewById(R.id.editPayment)).getText().toString()));
    ...
    private void initCancelButton() {
        Button cancelButton = findViewById(R.id.buttonCancelLoan);
